...
const ThemePreviewSvg: React.FC<ThemePreviewSvgProps> = ({ themeType, className }) => {
	const defsContent = (
		<defs>
			<linearGradient
				id='lightCardBg'
			...
			>
				...
				<stop
					offset='100%'
					style={{ stopColor: '#fafafa', stopOpacity: 1 }}
				/>
			</linearGradient>
			...
			>
				<stop
					offset='0%'
					style={{ stopColor: '#262626', stopOpacity: 1 }}
				/>
				<stop
					offset='100%'
					style={{ stopColor: '#1f1f1f', stopOpacity: 1 }}
				/>
			</linearGradient>
	...
	return (
		<svg
			viewBox='0 0 400 200'
			className={cn(className, 'w-[160px] h-[80px]')}
		>
			{defsContent}
